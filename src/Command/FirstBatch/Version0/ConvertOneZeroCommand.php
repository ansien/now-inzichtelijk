...
class ConvertOneZeroCommand extends Command
{
    protected static $defaultName = 'app:convert-1.0';
    ...
    protected function execute(InputInterface $input, OutputInterface $output): int
    {
        ...
        $handle = fopen('./public/file/first-batch/version-0/first-batch-0.txt', 'r');
        ...
        (new Filesystem())->dumpFile('./public/file/first-batch/version-0/first-batch-0.csv', $serializer->encode($dataArr, 'csv'));
